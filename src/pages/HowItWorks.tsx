    ...
    <div className="min-h-screen bg-gradient-to-b from-secondary/20 via-white via-30% to-white">
      ...
      <main className="pt-24 md:pt-32">
        ...
        <section className="section-padding bg-muted/30">
          <div className="container-custom px-6">
            <h2 className="text-center mb-16 animate-fade-in">The Data Journey</h2>
        ...
        <section className="section-padding">
          <div className="container-custom px-6">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-center mb-12 animate-fade-in">Key Concepts</h2>
              
              <div className="grid md:grid-cols-2 gap-6">
                <Card className="card-hover animate-fade-in-up">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold mb-3 text-primary">Interoperability</h3>
